...
import com.pdc.dto.AclDto;
import com.pdc.dto.AclModuleLevelDto;
import com.pdc.dto.DeptLevelDto;
...
public class SysTreeService {
    ...
    public List<DeptLevelDto> deptListToTree(List<DeptLevelDto> deptLevelList) {
        ...
        List<DeptLevelDto> rootList = Lists.newArrayList();//保存第一级DeptLevelDto
        for (DeptLevelDto dto : deptLevelList) {
            levelDeptMap.put(dto.getLevel(), dto);//此方法内部已经做了key重复问题的判断：如果重复，则直接添加
            if (LevelUtil.ROOT.equals(dto.getLevel())) {
                rootList.add(dto);
            }
        }
