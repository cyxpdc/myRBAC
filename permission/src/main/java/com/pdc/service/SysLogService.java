...
import com.pdc.dao.SysRoleMapper;
import com.pdc.dao.SysUserMapper;
import com.pdc.dto.SearchLogDto;
...
public class SysLogService {
    ...
    /**
     * before代表还没还原的对象，即当前对象
     * after代表还原后的对象，即需要还原的旧值
     * 其他方法类似
     * @param sysLog
     */
    private void recoverDept(SysLogWithBLOBs sysLog) {
    ...
    private void recoverUser(SysLogWithBLOBs sysLog) {
    ...
    private void recoverAclModule(SysLogWithBLOBs sysLog) {
    ...
    private void recoverAcl(SysLogWithBLOBs sysLog) {
    ...
    private void recoverRole(SysLogWithBLOBs sysLog) {
    ...
    private void recoverRoleUser(SysLogWithBLOBs sysLog) {
    ...
    /*public void saveRoleAcl(int roleId, List<Integer> before,List<Integer> after){
    }交给了SysRoleAclService自己实现
    public void saveRoleUser(int roleId,List<Integer> before,List<Integer> after){
    }交给了SysRoleUserService自己实现*/
}
